...
public class Statistics_____ implements Serializable
{
    ...
    private final static long serialVersionUID = -6046908445925766040L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public Statistics_____() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Statistics_____) == false) {
            return false;
        }
        Statistics_____ rhs = ((Statistics_____) other);
