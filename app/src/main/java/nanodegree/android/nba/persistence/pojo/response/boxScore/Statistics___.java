...
public class Statistics___ implements Serializable
{
    ...
    private final static long serialVersionUID = 2076235918865488647L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public Statistics___() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Statistics___) == false) {
            return false;
        }
        Statistics___ rhs = ((Statistics___) other);
