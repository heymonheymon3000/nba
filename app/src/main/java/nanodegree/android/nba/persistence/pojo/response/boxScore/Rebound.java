...
public class Rebound implements Serializable
{
     ...
     * @param srId
     */
    public Rebound(String fullName, String jerseyNumber, String id, String position, String primaryPosition, String srId, String reference, Statistics_ statistics) {
        super();
