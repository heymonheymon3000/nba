...
public class Statistics____ implements Serializable
{
    ...
    private final static long serialVersionUID = -8064735469826409022L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public Statistics____() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Statistics____) == false) {
            return false;
        }
        Statistics____ rhs = ((Statistics____) other);
