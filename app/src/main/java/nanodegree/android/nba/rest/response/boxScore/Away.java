...
public class Away implements Serializable
{
    ...
    @Expose
    private List<Scoring_> scoring = new ArrayList<Scoring_>();
     ...
     * @param srId
     */
    public Away(String name, String alias, String market, String id, Long points, Boolean bonus, String srId, String reference, List<Scoring_> scoring, Leaders_ leaders) {
        super();
        this.name = name;
        this.alias = alias;
        this.market = market;
    ...
    public List<Scoring_> getScoring() {
        return scoring;
    }

    public void setScoring(List<Scoring_> scoring) {
        this.scoring = scoring;
    }
