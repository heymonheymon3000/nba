...
public class Statistics_ implements Serializable
{
    ...
    private final static long serialVersionUID = -6371103243753395325L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Statistics_) == false) {
            return false;
        }
        Statistics_ rhs = ((Statistics_) other);
