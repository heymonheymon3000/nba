...
public class Assist implements Serializable
{
     ...
     * @param srId
     */
    public Assist(String fullName, String jerseyNumber, String id, String position, String primaryPosition, String srId, String reference, Statistics__ statistics) {
        super();
